...
\begin{table}[h]
    ...
    \hline Error (SMM) & {\color{red}0.4827}&\color{red}0.1903&\color{red}0.1020&\color{red}0.0663\\
    \hline
    \end{tabular}}
...
\hline
\end{tabular}}
\caption{\scriptsize Classification accuracy in linearly separable data case}
\label{tab: mcr}
\end{table}
...
\hline
\end{tabular}}
\caption{\scriptsize Classification accuracy in linearly non separable data case}
\end{table}
\end{itemize}
...
\[
\hat f(\cdot)= \sum_i \hat \alpha_iy_i\langle \cdot,X_i\rangle_{\hat\mP,h} = \sum_i \hat \alpha_iy_i \text{tr}\left[\mK(\cdot,\ \mX_i)\hat \mP^T\hat \mP \right].
\]
