...
\[
\mathbb{P}\left(\onenormSize{}{\hat f-f}\gtrsim t_n^{\alpha/(\alpha+2)}+{1\over H}+t_nH \right)\leq \mathbb{P	}(E^c)\leq He^{-cnt_n},
\]
where the last inequality comes from the union bound and Theorem~\ref{thm:unified}.
