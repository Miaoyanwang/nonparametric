...
result1 = svm(X,y)
##result2 = smm(X,y,3)
result2 = SMM(X,y,3,kernel = Expkernel)
x = dat[,-1]
...
ygrid12 = unlist(lapply(gridX12,function(x) result2$predict(x)))
ygrid13 = unlist(lapply(gridX13,function(x) result2$predict(x)))
